			...
			<div class="col-xs-3">
				<div class="serve_lf">
					<ul>
						...
						<li>
							<a href="record_3.jsp"   class="ac_s">修改密码</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="col-xs-9">
				<div class="record_ron">
					...
					<form class="form-horizontal">
					  ...
					  <div class="form-group">
						<label for="inputPassword_3" class="col-sm-2 control-label">验证新密码：</label>
						<div class="col-sm-10">
						  <input type="password" class="form-control" id="inputPassword_3" >
						</div>
					  </div>
					  <div class="form-group">
